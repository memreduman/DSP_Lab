...
typedef enum {
			hz24000 = 0x38 ,  // 24kHz from 12.288MHz MCLK  0011 1000 **NOT SURE**
      hz48000 = 0x00,  // 48kHz from 12.288MHz MCLK 
      hz8000 = 0x0C,   // 8kHz from 12.288MHz MCLK   0000 1100
      hz32000 = 0x18,  // 32kHz from 12.288MHz MCLK  0001 1000
